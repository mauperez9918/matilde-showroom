...
export const sectionsData = [
  ...
  {
    name: "Showroom",
    text: "Contamos con un espacio íntimo y personalizado en la zona norte de la ciudad de Córdoba para atender a tus necesidades en la búsqueda de estilo único.<br><br>Escribinos a nuestro número de WhatsApp para coordinar un día y horario que se ajuste a tu agenda.<br><br>Una vez confirmada la visita, te proporcionaremos la información necesaria para que nos encuentres fácilmente.<br><br>¡Esperamos con ansias tu visita a nuestro showroom!",
    media: perchero,
    number: "02",
    color: "bg-ms-blue",
